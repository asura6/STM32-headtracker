...
SWIGINTERN intArray *new_intArray(size_t nelements){
    return (int16_t *)calloc(nelements, sizeof(int16_t));
  }
SWIGINTERN void delete_intArray(intArray *self){
    free((char*)self);
  }
SWIGINTERN int16_t intArray___getitem__(intArray *self,size_t index){
    return self[index];
  }
...
SWIGINTERN void intArray___setitem__(intArray *self,size_t index,int16_t value){
    self[index] = value;
  }
SWIGINTERN int16_t *intArray_cast(intArray *self){
    return self;
  }
SWIGINTERN intArray *intArray_frompointer(int16_t *t){
    return (intArray *)(t);
  }
...
SWIGINTERN PyObject *_wrap_intArray___getitem__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg2 = (size_t)(val2);
  result = (int16_t)intArray___getitem__(arg1,arg2);
...
SWIGINTERN PyObject *_wrap_intArray___setitem__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "intArray___setitem__" "', argument " "3"" of type '" "int16_t""'");
  } 
  arg3 = (int16_t)(val3);
...
SWIGINTERN PyObject *_wrap_intArray_cast(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (intArray *)(argp1);
  result = (int16_t *)intArray_cast(arg1);
...
SWIGINTERN PyObject *_wrap_intArray_frompointer(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "intArray_frompointer" "', argument " "1"" of type '" "int16_t *""'"); 
  }
  arg1 = (int16_t *)(argp1);
...
SWIGINTERN PyObject *_wrap_Disconnect(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:Disconnect",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "Disconnect" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  Disconnect(arg1);
  resultobj = SWIG_Py_Void();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Disconnect", _wrap_Disconnect, METH_VARARGS, NULL},
